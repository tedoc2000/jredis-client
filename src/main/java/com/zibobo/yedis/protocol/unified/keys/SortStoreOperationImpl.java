...
public class SortStoreOperationImpl extends LongReplyOperationImpl implements
        SortOperation {
    ...
    private static final byte[] STORE = toBytes("STORE");
    ...
    public SortStoreOperationImpl(byte[] key, byte[] store,
            boolean alpha, SortOptions options, LongReplyCallback cb) {
        super(cb);
        this.key = key;
        this.alpha = alpha;
    ...
    public void initialize() {
        ...
        setVargsArguments(CMD, args, key, STORE, store);
    }
