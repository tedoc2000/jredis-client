...
public class ZinterstoreOperationImpl extends LongReplyOperationImpl implements
    ...
    private final static VarArgsCommand CMD = new VarArgsCommand("ZINTERSTORE");
    private final byte[] destination;
    private final byte[][] keys;
    private final double[] weights;
    private final Aggregation aggregate;

    public ZinterstoreOperationImpl(byte[] destination, byte[][] keys,
