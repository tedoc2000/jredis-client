...
public class ZrevrangebyscoreWithScoresOperationImpl extends
        BytesSetWithScoresReplyOperationImpl implements ZrevrangebyscoreWithScoresOperation {
    ...
    public ZrevrangebyscoreWithScoresOperationImpl(byte[] key,
